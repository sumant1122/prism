...
export default function ResourceIngestionPage() {
  ...
  return (
    <div className="grid">
      <div className="card">
        <h2 className="page-title">Resource Intake</h2>
        <p className="page-subtitle">
          Connect external platforms and ingest enterprise resource metadata for operational intelligence.
        </p>
      ...
      {result && (
        <div className="card">
          ...
          <div className="row" style={{ marginBottom: 8 }}>
            <span className="chip">Platform: {result.source}</span>
            <span className="chip">Owner: {result.owner}</span>
            <span className="chip">Capacity Signal: {result.resource_count}</span>
          </div>
          <p>
          ...
          <p>
            <strong>Domains:</strong> {result.fields.join(", ") || "None detected yet"}
          </p>
          <p>
